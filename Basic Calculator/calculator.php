...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    if (isset($_POST["calculate"]) && is_numeric($_POST["operand1"]) && is_numeric($_POST["operand2"]) &&is_string($_POST["operator"])) {
...
<body>
    ...
    <form class="form" method="POST" action="calculator.php">
        ...
        Number A: <input type="number" name="operand1" placeholder="operand1" required><br/>
